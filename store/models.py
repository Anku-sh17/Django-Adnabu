...
class Product(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    categories = models.OneToOneField(Category, related_name='products',on_delete=models.CASCADE)
...
class Variant(models.Model):
    ...
    image = models.OneToOneField(Image, related_name='variants', on_delete=models.CASCADE)
